...
class EventForm extends Component {
  ...
  render() {
    ...
    return (
      <Grid>
        <Script
          url='https://maps.googleapis.com/maps/api/js?key=AIzaSyAZLWl-o5B82eQ5WDVNKU-hIBxcZzrmLyo&libraries=places'
        ...
        <Grid.Column width={10}>
          <Segment>
            ...
            <Form onSubmit={this.props.handleSubmit(this.onFormSubmit)}>
              ...
              <Field name='description' type='text' component={TextArea} rows={3} placeholder='Tell us more about your event'/>
